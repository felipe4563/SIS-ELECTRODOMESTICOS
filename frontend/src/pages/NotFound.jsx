    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="text-center max-w-md w-full">
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-zinc-500/20 rounded-full p-6 border border-zinc-500/30">
            <FaMapSigns className="h-16 w-16 text-zinc-400" />
          </div>
        </div>

        <h1 className="text-4xl font-bold text-white mb-2">404</h1>
        <h2 className="text-xl font-semibold text-white/80 mb-3">Página no encontrada</h2>
        <p className="text-white/50 text-sm mb-8">
          La dirección que ingresaste no existe. Verifica la URL o regresa al inicio.
        </p>
