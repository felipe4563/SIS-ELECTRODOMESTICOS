...
export default function ArqueoDetalle() {
  ...
  useEffect(() => {
    gastosService.getFormData().then(r => setFormData(r.data)).catch(() => {});
  }, []);
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Link to={`/caja/arqueos/${arqueo.id_arqueo}/imprimir`}
      ...
      {modal === 'gasto' && formData && (
        <ModalGasto
          categorias={formData.categorias}
          sucursales={formData.sucursales}
          monedas={formData.monedas}
          cajaFija={{ id_caja: arqueo.id_caja, id_sucursal: arqueo.id_sucursal }}
