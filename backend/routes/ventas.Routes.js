...
router.post('/agregar-producto-rapido', authMiddleware, checkPermission('crear_menor', 'ventas'), ctrl.agregarProductoRapido);
...
router.get('/:id/preview', authMiddleware, checkPermission('ver_sucursal', 'ventas'), ctrl.getPreview);
